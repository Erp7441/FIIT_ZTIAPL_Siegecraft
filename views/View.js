export class View{
    ...
    drawTexture(){
        if(this.model.faction === 'player' && this.model.selected === true){
            this.context.filter = "grayscale(100%) brightness(60%) sepia(100%) hue-rotate(+50deg) saturate(600%) contrast(0.8)";
        }
        else if(this.model.faction === 'player'){
